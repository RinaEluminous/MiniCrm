...
<html lang="en">
  ...
  <body>
          ...
          <div class="card-body card-body-padding d-flex align-items-center justify-content-between">
            <div class="ps-lg-1">
              <div class="d-flex align-items-center justify-content-between">
                ...
                <a href="https://www.bootstrapdash.com/product/connect-plus-bootstrap-admin-template/?utm_source=organic&utm_medium=banner&utm_campaign=buynow_demo" target="_blank" class="btn me-2 buy-now-btn border-0">Admin Panel</a>
              </div>
            </div>
            <div class="d-flex align-items-center justify-content-between">
    ...
    <script src="{{ url('/assets/admin') }}/vendors/jquery-circle-progress/js/circle-progress.min.js"></script>
