            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-box">
                        ...
                        @include('layouts.flash-message')
                        <form class="row" method="post" action="{{route('company.update')}}" data-parsley-validate
                            ...
                            <div class="col-12 col-sm-6 form-group">
                                ...
                                <img src="{{ $logo_image_public_path.$arr_company['logo'] }}" alt="" height="100px"
                                    width="100px">

                                @else

                                <img src="{{url('/').'/storage/app/public/default.png' }}" alt="" height="100px"
                                    width="100px">
